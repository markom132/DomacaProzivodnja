  ...
  const NextArrow = ({ onClick }) => {
    return (
      <div className='nextArrow' onClick={onClick}>
        <svg xmlns="http://www.w3.org/2000/svg" style={{ width: "50px", height: "50px" }} fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
  ...
  const PrevArrow = ({ onClick }) => {
    return (
      <div className='prevArrow' onClick={onClick}>
        <svg xmlns="http://www.w3.org/2000/svg" style={{ width: "50px", height: "50px" }} fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
        ...
        <Slider {...settings} className='relatedList'>
          {product.relatedProducts.map((related) => (
            <div key={related.id} className='relatedCard'>
              <img src={related.image} alt={related.name} className='relatedImage' />
              <h4>{related.name}</h4>
