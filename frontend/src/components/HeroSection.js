...
import image2 from '../assets/resized_image.png';
...
const styles = {
  hero: {
    ...
    padding: '0 20px',
    textAlign: 'center',
    backgroundSize: 'contain', // Ili 'cover' u zavisnosti od efekta koji želite
    backgroundSize: 'cover',
    backgroundPosition: 'center', // Centriranje slike u okviru sekcije
